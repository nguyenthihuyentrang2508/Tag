    ...
    <ul>		
		      	...
		      	<li>
		        	<div class="dropdown">
                        ...
                        <a class="text-white font-weight-bold" style="font-size: 120%;" href="{{url('/')}}"><i class="fas fa-home mr-2"></i>Trang chủ</a>
                        </button>					  
				      </div>
		        </li>
    </ul>           
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{route('user.index')}}">Liệt kê user</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('reportcomment.index')}}">Các bình luận bị báo cáo</a></li>
                        <li><a href="{{route('comment.index')}}">Liệt kê tất cả bình luận</a></li>
                        <li><a href="{{route('reporterror.index')}}">Liệt kê các thông báo lỗi</a></li>
                        <li><a href="{{route('reporterrortranh.index')}}">Liệt kê các thông báo lỗi tranh</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{url('liet-ke-truyen/'.auth()->user()->id)}}">Liệt kê truyện</a></li>
                        @endrole
                    </ul>
                </li>
                <!-- <li class="sub-menu">
