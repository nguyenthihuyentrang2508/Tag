...
<div class="container-fluid mt-2" style="margin-left: 120px">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">Danh sách truyện của Danh mục {{$danhmuc->tendanhmuc}}</div>
                ...
                <div class="card-body">
                 ...
                 <div style="width: 100%">   
                    <h5 class="float-left"> Tổng số chương <span style="color: blue"> ({{$count_truyen}}) <span></h5>
