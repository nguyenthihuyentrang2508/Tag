    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card"  style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                <div class="card-header text-center font-weight-bolder">{{ __('Let sign up here!') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-4 mt-4">
                            <div class="line float-left mt-2" style="border: 1px solid #EEEEEE; width: 30%"></div>
                                <p class="float-left ml-2 text-center font-weight-bold" style="font-size: 12px; width: 36%; color:  #A9A9A9">OR SIGN UP WITH EMAIL</p>
                        ...
                        <div class="text-center mt-2"> 
                            @if (Route::has('login'))   
                                    <div class="custom-control m-0">    
                                        ...
                                        <a href="{{ route('login') }}" class="m-0" style="color:  #ff631c; font-size: 14px;">
                                        {{ __('Login') }}
                                        </a> 
                                        here!
                                    </div>    
