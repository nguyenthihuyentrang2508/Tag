...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb shadow-sm">
    ...
    <li class="breadcrumb-item" aria-current="page">{{$theloai_id->tentheloai}}</li>
  </ol>
</nav>

	<div class="row p-0">
		<div class="col-8 m-0">
            <p class="mt-4 m-0 text-center" style="font-size: 145%;">Thể loại<b class="ml-1">{{$theloai_id->tentheloai}}</b></p>
            <p class="p-3" style="border: 1px solid #D3D3D3">{{$theloai_id->mota}}</p>
<style type="text/css">
.btn1 {
  border: none;
  outline: none;
                ...
                <div class="box_content">
                   <!-- List group -->
                    <div class="list-group m-0" id="myList" role="tablist">
                        ...
                        <a style=" background: #ff631c; color: white;" class="list-group-item list-group-item-action"><h5 class="m-0">Tất cả Thể loại</h5></a>
                        @foreach($theloai as $key => $cate)
                        <a class="list-group-item list-group-item-action" href="{{url('the-loai/'.$cate->slug_theloai)}}">{{$cate->tentheloai}}</a>
                        @endforeach
                    </div>
                </div>
            </div>
